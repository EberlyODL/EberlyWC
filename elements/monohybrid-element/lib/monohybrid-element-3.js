 ...
 */
class MonohybridElement3 extends LitElement {
  /**
   * Store the tag name to make it easier to obtain directly.
   * @notice function name must be here for tooling to operate correctly
   */
  tag() {
    return "monohybrid-element-3";
  }
...
customElements.define("monohybrid-element-3", MonohybridElement3);
export { MonohybridElement3 };
