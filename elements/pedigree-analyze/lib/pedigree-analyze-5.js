 ...
 */
class PedigreeAnalyze5 extends LitElement {
  /**
  ...
  render() {
    return html`
      <p>
        The probability that the third child will have the disease is 1/4 (if
        this does not make sense draw a punnett square).
      </p>
      ${this.renderSVG()}
    `;
  }
...
customElements.define("pedigree-analyze-5", PedigreeAnalyze5);
export { PedigreeAnalyze5 };
