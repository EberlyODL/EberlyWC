...
class CondensationElement extends LitElement {
  ...
  renderSVG() {
    ...
    <svg id="circles" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 470 128">
      <title>Condensation Reaction</title>
      <g id="circle">
        ...
        <text id="monomer" transform="translate(244.83 75.83)" font-size="12" fill="#231f20" font-family="OpenSans, Open Sans">Monomer</text>
      </g>
